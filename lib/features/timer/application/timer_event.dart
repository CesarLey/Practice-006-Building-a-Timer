...
/// timer. It can optionally accept a custom duration.
class TimerReset extends TimerEvent {
  const TimerReset({this.customDuration});
  final int? customDuration;

  @override
  List<Object> get props => [customDuration ?? 0];
}

/// The `TimerLapPressed` class represents an event when the lap button is pressed during timer execution.
